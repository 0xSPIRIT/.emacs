...
(custom-theme-set-faces
 'pure
 '(default ((t (:family "Lucida Console" :foundry "outline" :width normal :height 102 :weight normal :slant normal :underline nil :overline nil :extend nil :strike-through nil :box nil :inverse-video nil :foreground "SystemWindowText" :background "SystemWindow" :stipple nil :inherit nil))))
 '(cursor ((t (:background "gray50"))))
